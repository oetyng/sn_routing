...
## [0.38.0](https://github.com/oetyng/sn_routing/compare/v0.1.50...v0.38.0) (2021-05-06)
...
* add Envelope and InfrastructureQuery ([e0b999f](https://github.com/oetyng/sn_routing/commit/e0b999f961b971b068cad65bfe8e8f938bf4ab41))
* add sibling key to Event::EldersChanged ([afd33e3](https://github.com/oetyng/sn_routing/commit/afd33e3607b6a467145042fffd9ff274dd5c89b4))
* do not create connection when failed to send to client ([d5eadd8](https://github.com/oetyng/sn_routing/commit/d5eadd8dc2ae88af2ed26f2e9b0d58c20a69a516))
* having EldersInfo change candidate considered as DKG in progress ([6137123](https://github.com/oetyng/sn_routing/commit/61371230e2eab7ceff4fd80073843d6b46ff4adf))
* implement new SectionChain that can resolve forks ([a3d786f](https://github.com/oetyng/sn_routing/commit/a3d786feb6f2bf6314c550423ec2789313fbf7be))
* improve fork diagnostics ([dbf9807](https://github.com/oetyng/sn_routing/commit/dbf98072a98bba734c6e0458936fa3aaa56ddeb6))
* notify adult nodes with own section's adult list ([b4dddc0](https://github.com/oetyng/sn_routing/commit/b4dddc0fcc13ca196ccb66ff43a05ea91c72c732))
* restore aggregate at source ([4e86a20](https://github.com/oetyng/sn_routing/commit/4e86a20c6479a5cafda953e38fb61ca2b6d347d7))
* vote DKG non_participants off ([c4d6067](https://github.com/oetyng/sn_routing/commit/c4d6067679003de74380f218cd91e9f529c8bb5d))
* **api:** add new API for an Elder node to propose that a node has gone ([2937e59](https://github.com/oetyng/sn_routing/commit/2937e5938e84560850efd4eb892dcd353bc7790e))
* **messaging:** restore target group size ([02fca6e](https://github.com/oetyng/sn_routing/commit/02fca6ead186bddc3577e1ae2177c90e2b6e69d1))
* keep the genesis key and use it for fallback proofs ([99fb5ca](https://github.com/oetyng/sn_routing/commit/99fb5cacb4bd0782e3cbea3065b01c47ab1ee840))
* kill elder received too many connectivity complaints ([cc9ca8a](https://github.com/oetyng/sn_routing/commit/cc9ca8a39a24ff048d47d6a6c4d9dff07f1e1f40))
* last byte of node's name represents its age ([69cef7a](https://github.com/oetyng/sn_routing/commit/69cef7aa7564b7ce86374de22314431c88073470))
* log send to client error ([ddeff5e](https://github.com/oetyng/sn_routing/commit/ddeff5e0bf41dfdba3430a8df9ed4b51224822f9))
* make use of sn_messaging crate for messaging serialisation/deserialisation ([cbc4802](https://github.com/oetyng/sn_routing/commit/cbc48026e6d1e32cde8a3f1f7ab92ca7aed801ad))
* modify bootstrap to use infrastructure queries ([9fb438f](https://github.com/oetyng/sn_routing/commit/9fb438f6a3c209a50733fd6b894cf4e4ca2861bc))
* new API: Routing::section_key ([486ee61](https://github.com/oetyng/sn_routing/commit/486ee61dfd77eaffcb2bd86c8c0eba6f470ec678))
* nodes using different ages ([abb39c1](https://github.com/oetyng/sn_routing/commit/abb39c1e190582df02367ad75fb7e6d6f3a4e985))
* notify client of incorrect section_key ([c54f034](https://github.com/oetyng/sn_routing/commit/c54f034fdc304106d1a3e56e00012773b1e85a9d))
* remove neighbour restriction ([269cff0](https://github.com/oetyng/sn_routing/commit/269cff02f17da755996f8189d20d4c1b2d2f3101))
* remove unused Error::NodeMessaging variant ([0b70c28](https://github.com/oetyng/sn_routing/commit/0b70c28792076599af88dd61f9f6482116c2f3e4))
* remove unused events and event properties ([238a301](https://github.com/oetyng/sn_routing/commit/238a3016a1731a3abc7ca91b83e546992af85ec0))
* return TryJoinLater error when network disallow join ([a5e4d4b](https://github.com/oetyng/sn_routing/commit/a5e4d4bc0a086a9165545c40c9ba7e1471b043ff))
* support adding additional proof chain keys to user messages ([2275730](https://github.com/oetyng/sn_routing/commit/2275730e276a5296dfe3a6b8c95fb6f516787aba))
* use supermajority agreement + increase elder size to 7 ([b729a87](https://github.com/oetyng/sn_routing/commit/b729a870b58ea1e99099a374e4d21da76109b7f5))
* **accumulation:** add support for accumlation at dest node ([f892838](https://github.com/oetyng/sn_routing/commit/f892838c994f243e6be17b5276b1c80ff10f5c3a))
* **chain:** expose SectionChain via API ([1590414](https://github.com/oetyng/sn_routing/commit/15904147c279bbdd628fd3048d00d706e81061ea))
* **enduser:** add mapping between socketaddr and pk ([1ff902d](https://github.com/oetyng/sn_routing/commit/1ff902da2f28d89ed6ecb3efe502efea8476135e))
* **event:** add separate genesis event ([681d2c7](https://github.com/oetyng/sn_routing/commit/681d2c7c4d244f0ebf9016169c5b23c406b9f723))
* **event:** expose previous key in elderschanged ([0718e0c](https://github.com/oetyng/sn_routing/commit/0718e0ca7d11fb3cd4b0d3571909f3318514ec0c))
* **event:** update elders_changed event ([af37d06](https://github.com/oetyng/sn_routing/commit/af37d065b3eb3171ec9f68e4e665ad89ef01da81))
* replace (old) SectionProofChain with (new) SectionChain ([03fb82c](https://github.com/oetyng/sn_routing/commit/03fb82cbf20b8f881bdb0df6a781e3f95f8f0118))
* support dst accumulation with any message variant ([cc2f413](https://github.com/oetyng/sn_routing/commit/cc2f41361162a9ab0b2eab3d144de6cfb8152fe3))
* updates for section key response changes ([71f89d8](https://github.com/oetyng/sn_routing/commit/71f89d8c54008ff9974f740eff5be9ac2b893f26))
* use src from itinerary for dst accumulated user message ([31838e9](https://github.com/oetyng/sn_routing/commit/31838e99772cf8e2cc3cc901ba3ce47466270d11))
* use XorName instead of Prefix for section message src ([d2347ee](https://github.com/oetyng/sn_routing/commit/d2347eee21a3d5e86ae0c76e133e00cc1a850eeb))
* **keycache:** adds a key cache and removes exposure of secret key ([b312446](https://github.com/oetyng/sn_routing/commit/b312446b6db2c2beaf6007d39619dd8969fc8428))
* **messages:** remove MsgEnvelope ([57df069](https://github.com/oetyng/sn_routing/commit/57df069f6ed5d7c9afe3b665158181cce70ceb15))
* **stress test:** improve output ([33eac1b](https://github.com/oetyng/sn_routing/commit/33eac1b61383f231d0c34657db98d00cc84cf7c3))
* add bootstrap message backlog ([75f0a5c](https://github.com/oetyng/sn_routing/commit/75f0a5c751835aba15a3cd42ae3b30900f6b1428))
* add stress test example ([cf25c48](https://github.com/oetyng/sn_routing/commit/cf25c48d3ba613db0a1e631620727a31f87d2661))
...
* remove old DKG sessions ([c8db72f](https://github.com/oetyng/sn_routing/commit/c8db72f8120c538ed41cbe1d036106ba3c0c04d9))
...
* set filter number boundary ([c129bff](https://github.com/oetyng/sn_routing/commit/c129bff69d92400202bcefd1983eb028e3a26155))
...
* support multiple concurrent DKGs ([98fc101](https://github.com/oetyng/sn_routing/commit/98fc10194ddd73387a5539ad1e29423a224583d5))
...
* notification only about live adults ([01a8524](https://github.com/oetyng/sn_routing/commit/01a8524db851cf120d338347b2e1435976a4f8ba))
* only send adult list notification when no elder changing ([4964a20](https://github.com/oetyng/sn_routing/commit/4964a20fab42e78b6a1cab0951dcbdde7bc53449))
* only send to client directly when it belongs to self section ([b8ddc1b](https://github.com/oetyng/sn_routing/commit/b8ddc1b86f728c08734bbf06d4a5c63ee63a4f4b))
* **connectivity:** use separate endpoint to test connectivity to new ([26a2bcc](https://github.com/oetyng/sn_routing/commit/26a2bccdcc7659e3d585bacd24b31ab842e4f5c0))
* **delivery_targets:** deliver to all when targets are final dst ([f26722b](https://github.com/oetyng/sn_routing/commit/f26722b156194cb834d02cf33e53a54b1cd3b6a0))
* **tests:** refactor delivery group tests ([6437b76](https://github.com/oetyng/sn_routing/commit/6437b76bdc632366a71f00d0fdb55fc3947f44ab))
* add missing routing to client of relayed client message ([fbde5b1](https://github.com/oetyng/sn_routing/commit/fbde5b10d734fcf5037b0d37767ba5093376e46e))
* addresss review comments ([27dcac5](https://github.com/oetyng/sn_routing/commit/27dcac57b78daa9b41c481ed3970453d172720b4))
* adults not able to send non-aggregated messages ([9248cd0](https://github.com/oetyng/sn_routing/commit/9248cd071a7c5f2a7dd95ac201a40267c3ac3e6a))
* always send their Offline vote to relocated elders ([7f77e97](https://github.com/oetyng/sn_routing/commit/7f77e970adaf30c4653a60299829501e90453a4e))
* avoid invalidating signature when resending bounced Sync message ([d482dab](https://github.com/oetyng/sn_routing/commit/d482dab96b8e2bdd5d49aa1579b50bce8f459e64))
* bounce untrusted messages directly to the original sender ([1bed232](https://github.com/oetyng/sn_routing/commit/1bed232ba085aa46fd71b3469366f5ab029aab8c))
* bug in SectionChain::minimize ([0eef78e](https://github.com/oetyng/sn_routing/commit/0eef78e2f7d3a729e38c2421a54be58ff07ff5d4))
* check trust with all known keys, not just the src matching ones ([2c9a1b2](https://github.com/oetyng/sn_routing/commit/2c9a1b280cee471514f8254cd82cf19deb1383b5))
* correctly handle section chain extend edge case ([cae05ba](https://github.com/oetyng/sn_routing/commit/cae05bab837e66e2a6f7754133f4937451e0bbe0))
* cover all cases of RelocatePromise handling ([5966d3d](https://github.com/oetyng/sn_routing/commit/5966d3db21045d7e56851bd22c2d46e9ebdf50bb))
* don't send OtherSection or vote TheirKnowledge to our section ([95f14d8](https://github.com/oetyng/sn_routing/commit/95f14d8ef869d263cc782e7faf91e7bc160dcf16))
* enable relocation again ([f9fde30](https://github.com/oetyng/sn_routing/commit/f9fde30572e19e2ef50cb3f75a47714f8670332a))
* ensure section elders info is always signed with the last chain key ([82fad1a](https://github.com/oetyng/sn_routing/commit/82fad1aca7d55e5b83b3af3658ffeae5f3873581))
* ignore Sync messages not for our section ([6d90fcf](https://github.com/oetyng/sn_routing/commit/6d90fcff2b2a1873b56915b8f3dc202b5394681b))
* issues pointed out in review comments ([d9a986e](https://github.com/oetyng/sn_routing/commit/d9a986e5f4df278dd87cf08cf6b77ab725a70455))
* make SectionChain::check_trust more strict ([8dcd021](https://github.com/oetyng/sn_routing/commit/8dcd0215ba4cb8d8d2d57c3782fbdd267a278065))
* make sure sibling section info is valid and trusted ([2044b11](https://github.com/oetyng/sn_routing/commit/2044b1106397071b581af8a64fae453d78f4ab3b))
* no router startup fixed w/qp2p udpate ([29b98ea](https://github.com/oetyng/sn_routing/commit/29b98eabe87921377b605c86ac8724453b55ba8f))
* no split in first section ([81a716f](https://github.com/oetyng/sn_routing/commit/81a716fce20da6a2521c0a41f2133d6704568d28))
* prevent creating Section with elders info signed with wrong key ([f0f839c](https://github.com/oetyng/sn_routing/commit/f0f839cb124c94fede41c9a21882e6b00c5743de))
* reduce unneeded lazy messages ([0498f24](https://github.com/oetyng/sn_routing/commit/0498f2447cc7cee91b1a897b0227d806861782a3))
* relocated allowed to join with own age ([018a9b8](https://github.com/oetyng/sn_routing/commit/018a9b8d1ae3e189f6381641f7721e419d5d13a7))
* relocated node can have higher age to join after first section split ([68b3e1e](https://github.com/oetyng/sn_routing/commit/68b3e1e1335b2ca6b23c2779fef013793d694e3d))
* remove offline elder from vote recipients ([3bcea21](https://github.com/oetyng/sn_routing/commit/3bcea21ceb00feacc52843cc435fe875d3ed3f84))
* remove potential panic in SignedRelocateDetails ([23d0936](https://github.com/oetyng/sn_routing/commit/23d09363211fc6d957f74ef85bc103c27685644b))
* respond with GetSectionResponse::Redirect on missing pk set ([69a1fb8](https://github.com/oetyng/sn_routing/commit/69a1fb840cbbb54b8ccb5af8856e3991d3ac46dd))
* restore EldersChange to a previous version ([0a85b87](https://github.com/oetyng/sn_routing/commit/0a85b879d5a2173daf24f49fbb3e106ecc0a0f5d))
* send OtherSection to src of the original message, not src section ([cd3e382](https://github.com/oetyng/sn_routing/commit/cd3e38226af242950ce06797ea2ebf308b9cea31))
* **bootstrap:** avoid duplicate GetSectionRequest ([84327e2](https://github.com/oetyng/sn_routing/commit/84327e2521dfcace503886e3d4b79c3118cc4464))
* **bootstrap:** require GetSectionResponse to match our destination, not name ([4f484f1](https://github.com/oetyng/sn_routing/commit/4f484f1ea93f5d83180d5c77fcb5b3a680322d31))
* **dkg:** allow multiple pending key shares ([92dfc70](https://github.com/oetyng/sn_routing/commit/92dfc70a8bd18108f0c3a2f6d657b1e72e0a76cd))
* **dkg:** avoid mixing DKG messages from different generations ([e68ba2a](https://github.com/oetyng/sn_routing/commit/e68ba2aad975285c3968a67b38040d110c4f7d78))
* **dkg:** detect corrupted DKG outcome ([ec53c63](https://github.com/oetyng/sn_routing/commit/ec53c63a78e5cf776219b75cb2c678710f9b34ae))
* **stress-test:** fix probe message sending ([a8a184c](https://github.com/oetyng/sn_routing/commit/a8a184c70f57801140d4fb521b230485ab353727))
* **test:** increase the number of nodes in the drop test from 3 to 4 ([9ce0ec7](https://github.com/oetyng/sn_routing/commit/9ce0ec7da7483eacd9f5941bad470a4a821d0fd3))
* post-rebase issues ([906ef03](https://github.com/oetyng/sn_routing/commit/906ef031585f3db19a546928e76c8304a7f3c7f3))
* remove unnecessary error mapping ([0f3418b](https://github.com/oetyng/sn_routing/commit/0f3418b2ea4d66f438604ded2682d76f95e70d6f))
* remove use of wildcard match and unimplemented macro ([84c53d8](https://github.com/oetyng/sn_routing/commit/84c53d8db16f1ab237c46ad5e8221b2a80758d54))
* resolve a doc failure ([d51f0c6](https://github.com/oetyng/sn_routing/commit/d51f0c62534fe03add884bdb060105c1bd7c394b))
* use chain main branch length as the DKG generation ([ed3a54e](https://github.com/oetyng/sn_routing/commit/ed3a54e635661f6bb59d968a8a4c3d091f2a8587))
* **comm:** dont hold on to messages sent on a channel that is unused ([92856cd](https://github.com/oetyng/sn_routing/commit/92856cd8daf51af109405d1b9b58b7fa0a5f2d9c))
* **dst-accumulation:** verify aggregated signature with proof chain ([bd99595](https://github.com/oetyng/sn_routing/commit/bd99595379307f0f6b19bccaac0b3b8e145e0fcf))
* allow only one relocation at the time per node ([0e4d05f](https://github.com/oetyng/sn_routing/commit/0e4d05f7f06349512a63a912a832cbab0631e429))
* avoid over relocation ([989529c](https://github.com/oetyng/sn_routing/commit/989529cafd1903e9009f4f66b1d111819d89be9c))
...
* don't fail in update_state if secret key share is missing ([97d8266](https://github.com/oetyng/sn_routing/commit/97d8266042d1c21c02b8015aa5be38ad009c8224))
...
* redirect to our elders on mismatching GetSectionRequest as adult ([22c4745](https://github.com/oetyng/sn_routing/commit/22c47453a50d79b47771c9afb682d3cac88aeb12))
...
* send messages with correct MessageKind byte ([6756b43](https://github.com/oetyng/sn_routing/commit/6756b43d969d26afe9305ee4ff2851c6e9193495))
* **clippy:** remove clone (undetected in local clippy check) ([da6cbc7](https://github.com/oetyng/sn_routing/commit/da6cbc7af578649907202d74676caee1623af278))
...
* ignore elders update with incorrect prefix ([dfc9c60](https://github.com/oetyng/sn_routing/commit/dfc9c60278fe78fdd5fbb4de14b5cc2721dbf570))
* ignore invalid bootstrap response ([3d8cfd5](https://github.com/oetyng/sn_routing/commit/3d8cfd583c16cff7c25b82c142c80aa6348852e3))
...
* **stress test:** ignore InvalidSource errors when sending probes ([adabf82](https://github.com/oetyng/sn_routing/commit/adabf82f7da0f8b6669e8f28cc9fb7fca02f67b2))
...
* reject SectionInfo votes not voted by a participant ([c40dc12](https://github.com/oetyng/sn_routing/commit/c40dc12bb1f64f6b22695c0541479c2dbc26fd8f))
* send Sync messages on split even when demoted ([5f42b78](https://github.com/oetyng/sn_routing/commit/5f42b78c4bcd68720399d9553512057d8b7d4d0d))
* trust check failure of Sync message sent to non-elders ([5520c18](https://github.com/oetyng/sn_routing/commit/5520c182e1f3c29ce560d3fbb6e1e7e74324ac47))
* use keys not key indices to check whether elders changed ([a99a07f](https://github.com/oetyng/sn_routing/commit/a99a07f80b706d7fe84b5d970ee10999910db395))
...
* **stress test:** fix log to file and probe message destination ([c933605](https://github.com/oetyng/sn_routing/commit/c933605df7847b05afd5a0b497cc315381e99955))
* **stress test:** fix sent probe messages counter ([b9b7530](https://github.com/oetyng/sn_routing/commit/b9b7530fe383142541da5164e46455fe84287565))
...
* use age assigned by section ([4db6351](https://github.com/oetyng/sn_routing/commit/4db63514d4b4f8fe226bc76d97ca33f0e646165a))
...
* for aggregate_at_src message, notify sn_node with proof as well ([8a39aaa](https://github.com/oetyng/sn_routing/commit/8a39aaa936ea6e478bb1d96bd49ca390d62297c0))
...
* **data-types:** upgrading data-types to v0.16.0 and sn_messaging to v8.0.0 ([5e39755](https://github.com/oetyng/sn_routing/commit/5e397559e7f4b907276f2a2f689cb519d304b8be))
* **dep:** update qp2p dependency ([3efb8c5](https://github.com/oetyng/sn_routing/commit/3efb8c54906397a5dd676cfb835eb22e3d453e40))
* **deps:** update sn_messaging ([91a7c55](https://github.com/oetyng/sn_routing/commit/91a7c5513156c67f058fc61f84faef38f874d886))
* **deps:** update sn_messaging ([c7c4108](https://github.com/oetyng/sn_routing/commit/c7c410895fb95f561a5e207017d2cacc9b25a3ef))
* **deps:** update sn_messaging ([ecc376d](https://github.com/oetyng/sn_routing/commit/ecc376d0199cdfa6191acfe943fe01ec67f2df91))
* **deps:** update sn_messaging ([1b1fdf7](https://github.com/oetyng/sn_routing/commit/1b1fdf7756bb287bd5c2b4c7637febf6a03e5a58))
* **deps:** update sn_messaging ([8d61421](https://github.com/oetyng/sn_routing/commit/8d61421e1d8b92c0d52d2bdb964bee4095b70084))
* **deps:** update sn_messaging to 0.19.0 ([c79313d](https://github.com/oetyng/sn_routing/commit/c79313d69406abec71290266cb63fd01cb70575f))
* **deps:** update sn_messaging to v20.0.0 ([2417d53](https://github.com/oetyng/sn_routing/commit/2417d5338244d6ad76865c0dc670875efff5cd12))
* breaking version change ([0fb090c](https://github.com/oetyng/sn_routing/commit/0fb090cd0136661adad0b6e7f37bba5ae4858a87))
* DT dep update ([7fb8a4a](https://github.com/oetyng/sn_routing/commit/7fb8a4a6ebed7e1990de4acdd38feca89cb52d1a))
* **deps:** update sn_messaging, sn_data_types ([367b673](https://github.com/oetyng/sn_routing/commit/367b6731b90b7211679282b2fcaa8852f3449ccd))
* **messaging:** add expected aggregation scheme, and use an itinerary ([a79d2d0](https://github.com/oetyng/sn_routing/commit/a79d2d0f837354c46282410d387b2276af525848))
* **tokio:** upgrade tokio to v1.2.0 and qp2p 0.10.0 ([e5adc1a](https://github.com/oetyng/sn_routing/commit/e5adc1a6e21c4b7f3aa62497535b7740cd08a3f3))
* fix clippy errors with version 1.50.0 of rust ([b6b385a](https://github.com/oetyng/sn_routing/commit/b6b385aa1d05a8ac908f568d4537bb64589cd470))
* remove `Error::UntrustedMessage` ([dbcf0db](https://github.com/oetyng/sn_routing/commit/dbcf0db471f2b234342fdeeb68d5cf7aaff50846))
* remove Error::BadLocation ([3391c7f](https://github.com/oetyng/sn_routing/commit/3391c7f1d49e050ae2fe580816a10add68388d14))
